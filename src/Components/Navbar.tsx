...
export default function Navbar() {
  return (
    <>
    <nav className="  sticky top-0 left-0 w-full mx-auto  md:px-5 border-b-2 border-gray-200 py-2 text-3xl font-bold backdrop-blur-sm">
        <div className="container mx-auto flex items-center justify-between px-4">
          <div className="flex items-center gap-2">
          <FaQuoteRight className="text-primary text-2xl"/>
          <span className="font-serif text-2xl font-bold">QUOTES_ND_NOTES</span>
        </div>
